...
void
Point::Init(v8::Handle<v8::Object> target)
{
...
v8::Handle<v8::Value>
Point::New(const v8::Arguments& args)
{
...
/// getter for x
v8::Handle<v8::Value>
Point::GetPointX(v8::Local<v8::String> property,
...
/// setter for x
void
Point::SetPointX(v8::Local<v8::String> property, v8::Local<v8::Value> value,
        const v8::AccessorInfo& info)
{
...
v8::Handle<v8::Value>
Point::GetPointY(v8::Local<v8::String> property,
        const v8::AccessorInfo& info)
{
    v8::HandleScope scope;
    Point* point = ObjectWrap::Unwrap<Point>(info.Holder());
...
void
Point::SetPointY(v8::Local<v8::String> property, v8::Local<v8::Value> value,
        const v8::AccessorInfo& info)
{
    Point* point = ObjectWrap::Unwrap<Point>(info.Holder());
...
v8::Handle<v8::Value>
Point::Normalized(const v8::Arguments& args)
{
    v8::HandleScope scope;
